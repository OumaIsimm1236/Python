...
fenetre_connexion = None
  ...
  # Crée une instance de Entry
 entry1 = Entry(resultat)
  entry2 = Entry(resultat)
entry3 = Entry(resultat)
entry4 = Entry(resultat)
entry5 = Entry(resultat)
entry6 = Entry(resultat)
entry7 = Entry(resultat)
entry8 = Entry(resultat)
entry9 = Entry(resultat)
entry10 = Entry(resultat)
...
#lancement de la boucle de resultat
resulta.mainloop
